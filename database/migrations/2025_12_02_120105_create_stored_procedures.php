...
return new class extends Migration
{
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetAllInstructors');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetInstructorById');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_UpdateInstructor');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_DeleteInstructor');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetAllVehicles');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetVehicleById');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_UpdateVehicle');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_DeleteVehicle');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetAllClients');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetClientById');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetLessonsByInstructor');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetInstructorAvailableSlots');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetInvoicesByClient');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetInvoicesByStatus');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetInstructorRevenue');
        DB::unprepared('DROP PROCEDURE IF EXISTS sp_GetVehicleUsageStats');
    }
};
