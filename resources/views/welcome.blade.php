...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] antialiased min-h-screen">
    <div class="min-h-screen flex flex-col">
        <header class="w-full max-w-6xl mx-auto px-6 pt-6">
            @if (Route::has('login'))
        ...
        <main class="flex flex-1 items-center justify-center w-full px-6 py-12">
            <div
                class="flex w-full max-w-6xl flex-col-reverse lg:flex-row rounded-lg overflow-hidden shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.08)]">
                <div
                    class="text-[13px] leading-[20px] flex-1 p-6 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    <h1 class="mb-1 text-2xl font-medium">Let's get started</h1>
                ...
                <div
                    ...
                    <div class="text-center px-8">
                        <div
                            class="mx-auto flex h-24 w-24 items-center justify-center rounded-2xl bg-[#1b1b18] text-white dark:bg-white dark:text-[#1C1C1A] text-3xl font-semibold shadow-[0px_10px_30px_rgba(0,0,0,0.12)]">
                            L
                        </div>
                        <p class="mt-6 text-[#706f6c] dark:text-[#A1A09A]">Laravel starter page</p>
                    </div>
                    <div
